 ...
 * @author Andre
 */
public class FowardServiceCall extends javax.swing.JFrame {
    /**
     * Creates new form FowardServiceCall
     */
    public FowardServiceCall() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FowardServiceCall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FowardServiceCall().setVisible(true);
            }
        });
    }
