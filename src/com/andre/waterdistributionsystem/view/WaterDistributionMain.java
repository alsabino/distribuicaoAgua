...
public class WaterDistributionMain extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnName("Número do Chamado");
        ...
        columnBinding.setColumnName("Data de Fechamento");
        columnBinding.setColumnClass(java.util.Date.class);
        ...
        finishServiceCallButton.addActionListener(formListener);

        dateLabel.setText(controlDao.now());
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            else if (evt.getSource() == finishServiceCallButton) {
                WaterDistributionMain.this.finishServiceCallButtonActionPerformed(evt);
            }
        }
    }// </editor-fold>//GEN-END:initComponents

    /*botão com a finalidade de realizar a atualização dos dados na tabela que traz os registros do banco de dados*/
    @SuppressWarnings("unchecked")
    ...
    /*botão com a finalidade de abrir a tela de cadastro para um novo chamado e definir um titulo a tela*/
    ...
    /*botão com a finalidade de abrir a tela de encaminhamento de chamado e definir um titulo a tela*/
    ...
    private void finishServiceCallButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finishServiceCallButtonActionPerformed
        
        try {
            int id = Integer.parseInt(callIdField.getText());
        ServiceCall serviceCall = new ServiceCall();
        serviceCall.setCallId(id);
        DataSource dataSource = new DataSource();
        ServiceCallDAO controlDao = new ServiceCallDAO(dataSource);
        controlDao.finishService(serviceCall);
        refreshButtonActionPerformed(evt);
        } catch (NumberFormatException enf) {
            JOptionPane.showMessageDialog(null, "Selecione um dos chamados na tabela para ser finalizado!");
        }
        
    }//GEN-LAST:event_finishServiceCallButtonActionPerformed
