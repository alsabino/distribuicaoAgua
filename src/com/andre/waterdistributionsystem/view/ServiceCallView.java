...
public class ServiceCallView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        servicesCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ligar Registro", "Verificação Interna", "Verificação Externa ", "Verificação Rede( Água )", "Verificação Rede( Esgoto )", "Manutenção Rede( Água )", "Manutenção Rede( Esgoto )" }));
    ...
    private void saveServiceCallButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveServiceCallButtonActionPerformed
        ...
        Date date = null;
        try {
            date =  formatter.parse(getjFormattedTextField1().getText());
        ...
        serviceCall.setOpenDate(date);
        serviceCall.setStatus(getStatusTextField().getText());
